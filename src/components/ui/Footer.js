        ...
        <footer>
            <div className="footer-content">
                <div className="container">
                    <span className="footer__brand-container alignX">
                        <h2 className="footer__title">Nissan.</h2>
                    ...
                    <div className="footer__options">
                        <div className="row">
                            <ul className="col-sm col-md-3">
                                ...
                                <li><Link to="/"><span className="material-icons info-icon">error_outline</span> Información Legal</Link></li>
                            </ul>
                            <ul className="col-sm col-md-3">
